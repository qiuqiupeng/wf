...
/**
 * AbstractScmSysAccount entity provides the base persistence definition of the
 * ScmSysAccount entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
public abstract class AbstractScmSysAccount implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractScmSysAccount() {
	}

	/** minimal constructor */
	public AbstractScmSysAccount(String accountId) {
		this.accountId = accountId;
	}

	/** full constructor */
	public AbstractScmSysAccount(String accountId, String name,
			String password, String payPassword, String pwAnswer,
			String pwQuestion, String memberId, String nickName, String config,
			String favorite, String lastLoginIp, Date lastLoginTime,
			Integer loginCount, Integer status, String remark, Date updateTime,
			String updater, Date createTime, String creator, Integer removeTag,
			Integer sortId, String pinyin) {
		this.accountId = accountId;
		this.name = name;

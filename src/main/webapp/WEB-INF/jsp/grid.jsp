            ...
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe14b;"></span> Span12
                  </div>
                </div>
                <div class="widget-body">
                  Blogging, viral; value-added e-commerce matrix unleash open-source architectures--exploit e-tailers monetize, user-centred bricks-and-clicks. Users, web services seamless mission-critical harness semantic, authentic markets ecologies compelling optimize cross-platform rich-clientAPIs aggregate citizen-media." E-services synthesize B2B user-centric capture remix harness: user-contributed e-enable world-class rich, "integrate," morph.
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row-fluid">
            <div class="span6">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe14b;"></span> Span6
                  </div>
                </div>
                <div class="widget-body">
                  Functionalities deliver real-time, end-to-end create feeds enable podcasting, engage." Eyeballs value-added web services feeds platforms engage, "citizen-media platforms user-contributed plug-and-play.
                </div>
              </div>
            </div>
            <div class="span6">
          ...
          <div class="row-fluid">
            <div class="span4">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe14b;"></span> Span4
                  </div>
                </div>
                <div class="widget-body">
                  Bogospheres recontextualize podcasts paradigms value," envisioneer communities architect eyeballs e-enable iterate. Integrate models morph target brand, ecologies orchestrate reinvent share wikis killer cross-media technologies, dynamic aggregate.
                </div>
              </div>
            </div>
            <div class="span4">
              <div class="widget">
                ...
                <div class="widget-body">
                  CBogospheres recontextualize podcasts paradigms value," envisioneer communities architect eyeballs e-enable iterate. Integrate models morph target brand, ecologies orchestrate reinvent share wikis killer cross-media technologies, dynamic aggregate.
                </div>
              </div>
            </div>
            <div class="span4">
          ...
          <div class="row-fluid">
            <div class="span3">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe14b;"></span> Span3
                  </div>
                </div>
                <div class="widget-body">
                   Post reintermediate portals portals infrastructures e-services long-tail, e-commerce B2C, A-list networks dynamic citizen-media best-of-breed user-centred weblogs enhance? Architectures leverage clicks-and-mortar communities engineer robust frictionless long-tail real-time integrate?
                </div>
              </div>
            </div>
            <div class="span3">
          ...
          <div class="row-fluid">
            <div class="span2">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe14b;"></span> span2
                  </div>
                </div>
                <div class="widget-body">
                  Harness initiatives, e-tailers monetize models long-tail mashups robust.
                </div>
              </div>
            </div>
            <div class="span2">
          ...
          <div class="row-fluid">
            ...
            <div class="span8">
              <div class="widget no-margin">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe14b;"></span> Span8
                  </div>
                </div>
                <div class="widget-body">
                  Functionalities deliver real-time, end-to-end create feeds enable podcasting, engage." Eyeballs value-added web services feeds platforms engage, "citizen-media platforms user-contributed plug-and-play.

		...
		<div class="span6 pull-right">
			<div class="widget no-margin">
				<div class="widget-body">
					...
					<sj:a targets="content" cssClass="btn btn-primary input-top-margin btn-small "
					...
					<s:url id="action_edit_del" action="/user-edit!delete"
						namespace="/system" />
					<sj:a id="a_edit_del" cssClass="btn btn-warning2 hidden-tablet btn-small "
					...
					<s:url id="action_edit_save" action="user-edit!save"
						namespace="/system" />
					<sj:a targets="content" cssClass="btn btn-success btn-small "
						href="%{action_edit_save}" formIds="form">

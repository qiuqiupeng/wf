...
<body>
	<s:form id="form" action="" theme="simple"
				...
				<div class="widget no-margin">
					<div class="widget-body">
						...
						<s:url id="action_user_list_new" action="user-edit"
							namespace="/system" />
						<sj:a targets="content" cssClass="btn btn-success btn-small "
						...
						<sj:a cssClass="btn btn-warning2 hidden-tablet btn-small "
							onClickTopics="getselectedids">
							<span class="fs1" data-icon="&#xe0fd;"></span> 删除</sj:a>

						<button class="btn btn-warning input-top-margin btn-small " type="button">
							<span class="fs1" data-icon="&#xe14a;"></span> 刷新
						</button>
						<button class="btn btn-danger input-top-margin btn-small " type="button">
							<span class="fs1" data-icon="&#xe087;"></span> 修改密码
						</button>
						<button class="btn btn-primary input-top-margin btn-small " type="button">
							<span class="fs1" data-icon="&#xe08a;"></span> 解锁
						</button>
						<div class="btn-group input-top-margin btn-small ">
							<button class="btn btn-info">其他</button>
							<button data-toggle="dropdown"
								class="btn btn-info dropdown-toggle">
								<span class="caret"> </span>
							</button>
							<ul class="dropdown-menu pull-right btn-small ">
		...
		<sjg:grid id="gridtable" caption="用户列表" dataType="json"
			href="%{remoteurl}" pager="true" gridModel="gridModel" height="365"
			shrinkToFit="false" rowList="10,15,20" rowNum="15" viewrecords="true"
			rownumbers="true" resizable="true" multiselect="true"
			onDblClickRowTopics="openrowselect" autowidth="true" loadingText="数据载入中" >

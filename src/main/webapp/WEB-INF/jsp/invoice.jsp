                  ...
                  <div class="invoice">
                      ...
                      <div class="span3">
                        <div class="invoice-data-container">
                          <address class="no-margin">
                            ...
                            <span>
                              <abbr title="Phone">Phone :</abbr>  1234 5678 90,
                            </span>
                            <span>
                              <abbr title="Phone">Fax :</abbr>  123 456 7890,
                            </span>
                            <span>
                      ...
                      <div class="span3">
                        <div class="invoice-data-container">
                          <address class="no-margin">
                            ...
                            <span>
                              <abbr title="Phone">Phone :</abbr>  5678 5678 90,
                            </span>
                            <span>
                              <abbr title="Phone">Fax :</abbr>  321 456 7890,
                            </span>
                          </address>
                        </div>
                      </div>
                    ...
                    <table class="table table-condensed table-striped table-bordered table-hover no-margin">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="hidden-phone" colspan="6">
                            <a href="" class="btn btn-large btn-success pull-right">Pay Now</a>
                          </td>
                        </tr>
                      </tbody>
                    </table>

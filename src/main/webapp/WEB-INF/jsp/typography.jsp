            ...
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe100;"></span> Headings &amp; Paragraphs
                  </div>
                </div>
                <div class="widget-body">
                  ...
                  <div class="hero-unit">
                    ...
                    <hr>
                    <p>
                      Engineer Admin Dashboard strategize visualize architect folksonomies reinvent; Admin Dashboard front-end; world-class ROI disintermediate dynamic, web-Admin Dashboardd efficient B2B Srinu BAsava tag. Dashboard UI, benchmark, "benchmark,".
                    </p>
                  </div>
                  
                  <div class="hero-unit">
                    <h2 class="right-align-text">
                      Heading-2
                    </h2>
                  ...
                  <div class="hero-unit">
                    <h4 class="center-align-text">
                      Heading-4
                    </h4>
                    <p class="center-align-text">
                      Engineer Admin Dashboard strategize visualize architect folksonomies reinvent; enable front-end; world-class ROI disintermediate dynamic, web-enabled efficient B2B Srinu BAsava tag. Dashboard UI, benchmark, "benchmark,".
                    </p>
                  </div>
                  ...
                  <div class="hero-unit">
                    ...
                    <p>
                      Engineer enable strategize visualize architect folksonomies reinvent; enable front-end; world-class ROI disintermediate dynamic, web-enabled efficient B2B Srinu BAsava tag. Dashboard UI, benchmark, "benchmark,".
                    </p>
                  </div>
          ...
          <div class="row-fluid">
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe100;"></span> Paragraphs
                  </div>
                </div>
                <div class="widget-body">
                  ...
                  <div class="hero-unit">
                    <h4>
                      Engineer enable strategize
                    </h4>
                    <div class="row-fluid">
                      <div class="span1">
                        <img src="img/avatar-1.png" class="thumbnail" alt="StartUp Admin">
                      </div>
                      <div class="span11">
                        Engineer enable strategize visualize architect folksonomies reinvent; enable front-end; world-class ROI disintermediate dynamic, web-enabled efficient B2B Srinu BAsava tag. Dashboard UI, Dashboard, "benchmark,". Engineer Admin Dashboard strategize visualize architect folksonomies reinvent; Admin Dashboard front-end; world-class ROI disintermediate dynamic, web-Admin Dashboardd efficient B2B Srinu BAsava tag. Dashboard UI, benchmark, "benchmark,". Markets Admin UI; compelling citizen-media cross-platform Best Admin UI, ecologies revolutionary; beta-test web-Admin Dashboardd; revolutionize. Interactive. Markets Admin UI; compelling citizen-media cross-platform leading-edge, ecologies revolutionary; beta-test web-Admin Dashboardd; revolutionize. Interactive.
                      </div>
                    </div>
                    <br>
                    <div class="row-fluid">
                      <div class="span11">
                        Engineer Admin Dashboard strategize visualize architect folksonomies reinvent; Admin Dashboard front-end; world-class ROI disintermediate dynamic, web-Admin Dashboardd efficient B2B Srinu BAsava tag. Dashboard UI, benchmark, "benchmark,". Engineer Admin Dashboard strategize visualize architect folksonomies reinvent; Admin Dashboard front-end; world-class ROI disintermediate dynamic, web-Admin Dashboardd efficient B2B Srinu BAsava tag. Dashboard UI, benchmark, "benchmark,". Markets Admin UI; compelling citizen-media cross-platform leading-edge, ecologies revolutionary; beta-test web-Admin Dashboardd; revolutionize. Interactive. Markets Admin UI; compelling citizen-media cross-platform leading-edge, ecologies revolutionary; beta-test web-Admin Dashboardd; revolutionize. Interactive.
                      </div>
                      <div class="span1">
                        <img src="img/avatar-1.png" class="thumbnail" alt="StartUp Admin">
                      </div>
          ...
          <div class="row-fluid">
            <div class="span8">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe0b8;"></span> Blockquotes
                  </div>
                </div>
                <div class="widget-body">
                  ...
                  <blockquote class="pull-right">
                    ...
                    <p>
                      Wikis optimize mesh, "tagclouds productize communities," convergence user-centred, streamline best-of-breed user-centric. Convergence functionalities niches deploy brand, "social portals," networks harness.
                    </p>
                    <small>
                      Someone famous 
            ...
            <div class="span4">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe100;"></span> Headings
                  </div>
                </div>
                <div class="widget-body">
          ...
          <div class="row-fluid">
            <div class="span6">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe100;"></span> Description
                  </div>
                </div>
                <div class="widget-body">
            ...
            <div class="span6">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe100;"></span> Horizontal description
                  </div>
                </div>
                <div class="widget-body">
                  <div class="stylish-lists">
                    <dl class="dl-horizontal no-margin">
                      ...
                      <dd>
                        Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibhrisus.
                      </dd>
                    </dl>
                  </div>
                </div>
          ...
          <div class="row-fluid">
            <div class="span4">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe0b5;"></span> Unordered List
                  </div>
                </div>
                <div class="widget-body">
                  <div class="stylish-lists">
            ...
            <div class="span4">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe0b5;"></span> Lower Alpha List
                  </div>
                </div>
                <div class="widget-body">
                  <div class="stylish-lists">
            ...
            <div class="span4">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe0b5;"></span> Leading Zero List
                  </div>
                </div>
                <div class="widget-body">
                  <div class="stylish-lists">
          ...
          <div class="row-fluid">
              ...
              <div class="widget">
                ...
                <div class="widget-body">
                  <div >
                    <ul>
                      <li>
                        <span class="fs1" aria-hidden="true" data-icon="&#xe0a0;"></span> Aliquam velit
                      </li>
                      <li>
                        <span class="fs1" aria-hidden="true" data-icon="&#xe0d4;"></span> Porta lacus
                      </li>
                      <li>
                        <span class="fs1" aria-hidden="true" data-icon="&#xe1a0;"></span> Amet erat nunc
                      </li>
                      <li>
                        <span class="fs1" aria-hidden="true" data-icon="&#xe0a0;"></span> Porttitor lorem
                      </li>
                      <li>
                        <span class="fs1" aria-hidden="true" data-icon="&#xe0c0;"></span> Lorem it amet
                      </li>
                      <li>
                        <span class="fs1" aria-hidden="true" data-icon="&#xe1ab;"></span> Adipiscing elit
                      </li>
                      <li>
                        <span class="fs1" aria-hidden="true" data-icon="&#xe1a0;"></span> Molestie massa
                      </li>
                      <li>
                        <span class="fs1" aria-hidden="true" data-icon="&#xe0bf;"></span> Facilisis
                      </li>
                      
                      <li>
                        <span class="fs1" aria-hidden="true" data-icon="&#xe1ce;"></span> Facilisis aliquet
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div class="span3">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe0b5;"></span> Letter List
                  </div>
                </div>
                <div class="widget-body">
                  <div class="stylish-lists">
            ...
            <div class="span3">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe0b5;"></span> Roman List
                  </div>
                </div>
                <div class="widget-body">
                  <div class="stylish-lists">
            ...
            <div class="span3">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe0b5;"></span> Ordered List
                  </div>
                </div>
                <div class="widget-body">
                  <ol class="no-margin">

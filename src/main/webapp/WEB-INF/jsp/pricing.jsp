          ...
          <div class="row-fluid pricing-table">
            <div class="span4 plan">
              ...
              <ul>
                ...
                <li class="plan-feature">Single Domain</li>
                <li class="plan-feature">10 Email ID's</li>
                <li class="plan-feature">5TB Disk Space</li>
                <li class="plan-feature">
                  <a href="#" class="btn btn-warning2"><i class="icon-white icon-ok"></i> Select</a>
                </li>
              </ul>
            </div>
            <div class="span4 plan">
              <div class="plan-silver">
                ...
                <span style="text-decoration: line-through">$10.99</span> <span class="text-error">$9.99 -</span> <span class="label label-warning">Sale</span>
              </div>
              <ul>
                <li class="plan-feature">50 Users</li>
                <li class="plan-feature">5 Domains</li>
                <li class="plan-feature">200 Email ID's</li>
                <li class="plan-feature">10TB Disk Space</li>
                <li class="plan-feature">
                  <a href="#" class="btn btn-success"><i class="icon-white icon-ok"></i> Select</a>
                </li>
              </ul>
            </div>
            <div class="span4 plan">
              ...
              <ul>
                ...
                <li class="plan-feature">20 Domains</li>
                <li class="plan-feature">1000 Email ID's</li>
                <li class="plan-feature">Unlimited Space</li>
                <li class="plan-feature">
                  <a href="#" class="btn btn-warning"><i class="icon-white icon-ok"></i> Select</a>
                </li>
              </ul>
            </div>
          </div>

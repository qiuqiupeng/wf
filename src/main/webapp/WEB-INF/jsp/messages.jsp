    ...
    <div class="container-fluid">
      <div class="left-sidebar hidden-tablet hidden-phone">
        ...
        <div class="easy-pie-chart">
          <div class="pie_chart_1" data-percent="73">
            73%
          </div>
          <p class="name">
            Animated Chart
                  ...
                  <ul class="imp-messages">
                    <li>
                      ...
                      <div class="message-wrapper">
                        <h4 class="message-heading">Engineer enable strategize visualize architect</h4>
                        <blockquote class="message">Engineer enable strategize visualize architect folksonomies reinvent; enable front-end; world-class ROI disintermediate dynamic, web-enabled efficient B2B robust tag. Deliver, benchmark, "benchmark,".
                        </blockquote>
                        <br>
                        <p class="url">
                          <span class="fs1 text-info" aria-hidden="true" data-icon="&#xe0c5;"></span>
                          <a href="#">Engineer enable strategize visualize</a>
                        </p>
                      </div>
                    </li>
                    <li>
                      ...
                      <div class="message-wrapper">
                        ...
                        <blockquote class="message">Wikis optimize mesh, "tagclouds productize communities," convergence user-centred, streamline best-of-breed user-centric. Convergence functionalities niches deploy brand, "social portals," networks harness.
                        </blockquote>
                        <br>
                        <p class="url">
                          <span class="fs1" aria-hidden="true" data-icon="&#xe1b2;"></span>
                    ...
                    <li>
                      ...
                      <div class="message-wrapper">
                        ...
                        <blockquote class="message">Orchestrate "tagclouds mesh folksonomies utilize. Enable impactful niches engage integrateAJAX-enabled robust, "tagclouds mesh orchestrate folksonomies utilize best-of-breed user-centric. Convergence functionalities niches deploy brand.
                        </blockquote>
                        <ul class="thumbnails">
                    ...
                    <li>
                      ...
                      <div class="message-wrapper">
                        <h4 class="message-heading">Ecologies revolutionary; beta-test web-enabled; </h4>
                        <blockquote class="message">Markets mindshare; compelling citizen-media cross-platform leading-edge, ecologies revolutionary; beta-test web-enabled; revolutionize. Interactive.
                        </blockquote>
                      </div>
                    </li>
                    <li>
                      ...
                      <div class="message-wrapper">
                        <h4 class="message-heading">Semper eget lacinia odio sem nec elit onec id elit</h4>
                        <blockquote class="message">Vestibulum id ligula porta felis euismod semper eget lacinia odio sem nec elit onec id elit non mi porta gravida at eget metus.
                        </blockquote>
                        <br>
                        <p class="url">
                    ...
                    <li>
                      ...
                      <div class="message-wrapper">
                        <h4 class="message-heading">Vestibulum id ligula porta felis euismod semper eget</h4>
                        <blockquote class="message">A description list is perfect for defining terms euismod Vestibulum id ligula porta felis euismod semper eget.
                        </blockquote>
                      </div>
                    </li>
                    <li>
                      ...
                      <div class="message-wrapper">
                        <h4 class="message-heading">Udistinct and others a part of typography.</h4>
                        <blockquote class="message">Type design is a closely related craft, which some consider distinct and others a part of typography.
                        </blockquote>
                      </div>
                    </li>
                    <li>
                      ...
                      <div class="message-wrapper">
                        <h4 class="message-heading">Convergence functionalities niches deploy brand, "social portals.</h4>
                        <blockquote class="message">Wikis optimize mesh, "tagclouds productize communities," convergence user-centred, streamline best-of-breed user-centric. Convergence functionalities niches deploy brand, "social portals," networks harness.
                        </blockquote>
                        <br>
                        <p class="url">
                    ...
                    <li>
                      ...
                      <div class="message-wrapper">
                        ...
                        <blockquote class="message">"Tag clouds mesh orchestrate folksonomies utilize.</blockquote>
                      </div>
                    </li>
                    <li>
                      <img src="img/avatar-2.png" class="avatar" alt="Avatar">
                      ...
                      <div class="message-wrapper">
                        <h4 class="message-heading">Customized niches engage integrateAJAX-enabled robust</h4>
                        <blockquote class="message">Impactful niches engage integrateAJAX-enabled robust, "tagclouds mesh orchestrate folksonomies utilize.
                        </blockquote>
                        <br>
                        <p class="url">
                          <span class="fs1" aria-hidden="true" data-icon="&#xe1b2;"></span>
                    ...
                    <li>
                      ...
                      <div class="message-wrapper">
                        <h4 class="message-heading">Enable impactful niches engage integrateAJAX-enabled</h4>
                        <blockquote class="message">Markets mindshare; compelling citizen-media cross-platform leading-edge, ecologies revolutionary; beta-test web-enabled; revolutionize interactive.
                        </blockquote>
                      </div>
                    </li>
                    <li>
                      ...
                      <div class="message-wrapper">
                        <h4 class="message-heading">Markets mindshare; compelling citizen-media cross-platform</h4>
                        <blockquote class="message">Enable folksonomies utilize. Enable impactful niches engage integrateAJAX-enabled robust, "tagclouds mesh orchestrate folksonomies utilize.
                        </blockquote>
                        <br>
                        <p class="url">
                          <span class="fs1 text-info" aria-hidden="true" data-icon="&#xe0c5;"></span>
                          <a href="#">Markets mindshare</a>
                        </p>
                      </div>
                    </li>
                    <li>
                      ...
                      <div class="message-wrapper">
                        <h4 class="message-heading">Tagclouds mesh orchestrate folksonomies utilize</h4>
                        <blockquote class="message">Enable impactful niches engage integrateAJAX-enabled robust, "tagclouds mesh orchestrate "tagclouds mesh orchestrate folksonomies utilize.
                        </blockquote>
                      </div>
                    </li>
                    <li>
                      ...
                      <div class="message-date">
                        ...
                        <p class="month">Januuary</p>
                      </div>
                      <div class="message-wrapper">
                        <h4 class="message-heading">Ubiquitous customized ubiquitous e-business users</h4>
                        <blockquote class="message">Enable impactful niches engage integrateAJAX-enabled robust, "tagclouds mesh orchestrate.
                        </blockquote>
                        <br>
                        <p class="url">
                          <span class="fs1 text-error" aria-hidden="true" data-icon="&#xe132;"></span>

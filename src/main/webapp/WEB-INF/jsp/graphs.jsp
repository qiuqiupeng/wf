    ...
    <div class="container-fluid">
      <div class="left-sidebar hidden-tablet hidden-phone">
        ...
        <div class="content">
          <div id="accordion1" class="accordion no-margin">
            <div class="accordion-group">
              ...
              <div class="accordion-body collapse" id="collapseSeven" style="0">
        ...
        <div class="easy-pie-chart">
          <div class="pie_chart_1" data-percent="49">
            49%
          </div>
          <p class="name">
            Animated Chart
            ...
            <div class="span12">
              <div class="widget">
                ...
                <div class="widget-body">
                  <div id="social-catigories" style="height:180px;"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row-fluid">
            ...
            <div class="span4">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe095;"></span> Donut Chart
                  </div>
                </div>
                <div class="widget-body">
          ...
          <div class="row-fluid">
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe096;"></span> Area Chart
                  </div>
                </div>
                <div class="widget-body">
                  <div id="section-chart" style="height:240px;"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row-fluid">
            <div class="span12">
              <div class="widget no-margin">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe1cd;"></span> Realtime Chart
                  </div>
                </div>
                <div class="widget-body">

		...
		<ul class="nav nav-list">
			...
			<li><a href="#" class="dropdown-toggle"> <i
				...
				<ul class="submenu">
					...
					<li><sj:a onClickTopics="openURL" id="profile2">用户列表</sj:a></li>
	...
	<div class="ace-settings-box" id="ace-settings-box">
		...
		<div>
			<input type="checkbox" class="ace ace-checkbox-2"
				...
				for="ace-settings-navbar"> 改变导航条</label>
		</div>

		<div>
			<input type="checkbox" class="ace ace-checkbox-2"
				id="ace-settings-sidebar"> <label class="lbl"
				for="ace-settings-sidebar"> 改变 左边框</label>
		</div>

		<div>
			<input type="checkbox" class="ace ace-checkbox-2"
				id="ace-settings-breadcrumbs"> <label class="lbl"
				for="ace-settings-breadcrumbs"> 改变面包条</label>
		</div>
		...
		<div>
			<input type="checkbox" class="ace ace-checkbox-2"
				...
				for="ace-settings-add-container"> 紧缩内容 </label>
		</div>
	</div>
</div>

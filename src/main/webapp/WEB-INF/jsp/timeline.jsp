                ...
                <div class="widget-body">
                  <div class="timeline clearfix">
                    <ul>
                      <li>
                        <div class="user">
                          <img src="img/avatar-4.png" alt="StartUp Admin">
                        </div>
                        <div class="about-task info-task">
                          <div class="arrow info-arrow"></div>
                          <div class="header">Architectures <small>24th May @7pm</small></div>
                          <p>
                            Orchestrate "tagclouds mesh folksonomies utilize. Enable impactful niches engage integrateAJAX-enabled robust, "tagclouds mesh orchestrate folksonomies utilize best-of-breed user-centric. Convergence functionalities niches deploy brand. Orchestrate "tagclouds mesh folksonomies utilize. Enable impactful niches engage integrateAJAX-enabled robust, "tagclouds mesh orchestrate folksonomies utilize best-of-breed user-centric. Convergence functionalities niches deploy brand.
                          </p>
                          <ul class="thumbnails">
                            <li class="span2 no-bottom-margin no-bottom-padding">
                              <a href="#" class="thumbnail" data-original-title="">
                                <img alt="260x60" style="width: 260px; height: 60px;" src="img/saturation.png">
                              </a>
                            </li>
                          </ul>
                        </div>
                      ...
                      <li>
                        <div class="user-error">
                          <img src="img/avatar-6.png" alt="StartUp Admin">
                        </div>
                        <div class="about-task error-task">
                          <div class="arrow error-arrow"></div>
                          <div class="header">Reinvent <small>24th May @1:30pm</small></div>
                          <p class="no-margin">
                      ...
                      <li>
                        <div class="user-success">
                          <img src="img/avatar-2.png" alt="StartUp Admin">
                        </div>
                        <div class="about-task success-task">
                          <div class="arrow success-arrow"></div>
                          <div class="header">Incentivize <small>24th May @8:45am</small></div>
                          <p class="no-margin">
                      ...
                      <li>
                        <div class="user-warning">
                          <img src="img/avatar-8.png" alt="StartUp Admin">
                        </div>
                        <div class="about-task warning-task">
                          <div class="arrow warning-arrow"></div>
                          <div class="header">Metrics <small>23rd May @11:55pm</small></div>
                          <p class="no-margin">
                      ...
                      <li>
                        <div class="user-success">
                          <img src="img/avatar-5.png" alt="StartUp Admin">
                        </div>
                        <div class="about-task success-task">
                          <div class="arrow success-arrow"></div>
                          <div class="header">Mechnologies <small>21st May @7:35pm</small></div>
                          <p class="no-margin">
                      ...
                      <li>
                        <div class="user">
                          <img src="img/avatar-1.png" alt="StartUp Admin">
                        </div>
                        <div class="about-task info-task">
                          <div class="arrow info-arrow"></div>
                          <div class="header">Harness <small>29th April @8:30am</small></div>
                          <p class="no-margin">
                            Mechnologies incentivize virtual standards-compliant architectures empower.
                          </p>
                        </div>
                      ...
                      <li>
                        <div class="user-error">
                          <img src="img/avatar-7.png" alt="StartUp Admin">
                        </div>
                        <div class="about-task error-task">
                          <div class="arrow error-arrow"></div>
                          <div class="header">Engage value <small>24th April @6pm</small></div>
                          <p class="no-margin">
                      ...
                      <li>
                        ...
                        <div class="about-task success-task">
                          <div class="arrow success-arrow"></div>
                          <div class="header">Double fault <small>16th April @9pm</small></div>
                          <p class="no-margin">
                            Mechnologies incentivize virtual standards-compliant architectures empower.
                          </p>
                        </div>
                      ...
                      <li>
                        ...
                        <div class="about-task info-task">
                          <div class="arrow info-arrow"></div>
                          <div class="header">Pull back <small>14th April @12am</small></div>
                          <p class="no-margin">
                            Mechnologies incentivize virtual standards-compliant architectures empower..
                          </p>
                        </div>

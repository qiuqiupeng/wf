<!DOCTYPE html>
  ...
  <body>
            ...
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe1cd;"></span> Discrete Bar
                  </div>
                </div>
          ...
          <div class="row-fluid hidden-phone">
            <div class="span6">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe1cd;"></span> Horizontal Multi Bar
                  </div>
                </div>
                <div class="widget-body">
                  <div id="multi_bar_horizontal_chart">
            ...
            <div class="span6">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe1cd;"></span> Line &amp; Bar
                  </div>
                </div>
                <div class="widget-body">
                  <div id="line_plus_bar_chart">
                    <svg style="height: 240px;"></svg>
                  </div>
                </div>
              </div>
          ...
          <div class="row-fluid">
            <div class="span6">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe1cd;"></span> Scatter
                  </div>
                </div>
                <div class="widget-body">
            ...
            <div class="span6">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe1cd;"></span> Cumulative Line
                  </div>
                </div>
                <div class="widget-body">
                  <div id="cumulative_line_chart">
                    <svg style="height: 240px;"></svg>
                  </div>
                </div>
              </div>
          ...
          <div class="row-fluid hidden-phone">
            <div class="span12">
              <div class="widget">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe1cd;"></span> Stacked Area
                  </div>
                </div>
                <div class="widget-body">
                  <svg id="stacked_area_chart" style="height: 180px;"></svg>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row-fluid">
            <div class="span6">
              <div class="widget no-margin">
                <div class="widget-header">
                  <div class="title">
                    <span class="fs1" aria-hidden="true" data-icon="&#xe095;"></span> Social Graph
                  </div>
                </div>
                <div class="widget-body">
                  <div class="row-fluid">
                    ...
                    <div class="span4">
                      <div id="socialGraph_1" style="height: 160px;"></div>
                      <table class="table table-bordered table-condensed table-striped no-margin">
                        <tbody>
                          <tr>
                            <td>@srinubasava</td>
                    ...
                    <div class="span4">
                      <div id="socialGraph_2" style="height: 160px;"></div>
                      <table class="table table-bordered table-condensed table-striped no-margin">
                        <tbody>
                          <tr>
                            <td>@srinubasava</td>
              ...
              <div class="widget no-margin">
                ...
                <div class="widget-body">
                  <div class="row-fluid">
                    ...
                    <div class="span4">
                      <div id="socialGraph_4" style="height: 160px;"></div>
                      <table class="table table-bordered table-condensed table-striped no-margin">
                        <tbody>
                          <tr>
                            <td>@srinubasava</td>
                    ...
                    <div class="span4">
                      <div id="socialGraph_5" style="height: 160px;"></div>
                      <table class="table table-bordered table-condensed table-striped no-margin">
                        <tbody>
                          <tr>
                            <td>@srinubasava</td>
    ...
    <script src="js/nvd/cumulativeLineChart.js"></script>

    <script src="js/nvd/discreteBar.js"></script>
    <script src="js/nvd/discreteBarChart.js"></script>

    <script src="js/nvd/multiBarHorizontal.js"></script>
    <script src="js/nvd/multiBarHorizontalChart.js"></script>

    <script src="js/nvd/stackedArea.js"></script>
    <script src="js/nvd/stackedAreaChart.js"></script>

	...
	<div >
		...
		<div class="page-content">
			<div class="page-header">
				<h1>
					Inbox <small> <i class="icon-double-angle-right"></i>
				...
				<div class="col-xs-12">
								...
								<ul id="inbox-tabs"
									...
									<li class="li-new-mail pull-right"><a data-toggle="tab"
										href="#write" data-target="write" class="btn-new-mail"> <span
											class="btn bt1n-small btn-purple no-border"> <i
												class=" icon-envelope bigger-130"></i> <span
									...
									<li class="dropdown"><a data-toggle="dropdown"
										class="dropdown-toggle" href="#"> <i
											class="pink icon-tags bigger-130"></i> <span
											class="bigger-110"> Tags <i class="icon-caret-down"></i>
										</span>
									</a>

										<ul class="dropdown-menu dropdown-light-blue dropdown-125">
											<li><a data-toggle="tab" href="#tag-1"
												data-target="tag-1"> <span
													class="mail-tag badge badge-pink"></span> <span
											...
											<li><a data-toggle="tab" href="#tag-friends"
												data-target="tag-friends"> <span
													class="mail-tag badge badge-info"></span> <span
													class="blue">Friends</span>
											</a></li>

											<li><a data-toggle="tab" href="#tag-work"
												data-target="tag-work"> <span
													class="mail-tag badge badge-grey"></span> <span
													class="grey">Work</span>
											</a></li>
										</ul></li>
									<!-- /.dropdown -->
								</ul>
										...
										<div class="message-container">
												...
												<div class="message-bar">
													<div class="message-infobar" id="id-message-infobar">
														<span class="blue bigger-150">收件箱</span> <span
															class="grey bigger-110">(2 封未读)</span>
													</div>

													<div class="message-toolbar hide">
														<div class="inline position-relative align-left">
															<a href="#"
																class="btn-message btn btn-xs dropdown-toggle"
																data-toggle="dropdown"> <span class="bigger-110">处理</span>
															...
															<ul
																...
																<li><a href="#"> <i
																		class="icon-mail-reply blue"></i> &nbsp; Reply
																</a></li>
																...
																<li><a href="#"> <i
																		class="icon-eye-close green"></i> &nbsp; Mark unread
																</a></li>
														...
														<a href="#" class="btn btn-xs btn-message"> <i
															class="icon-trash bigger-125"></i> <span
													...
													<div class="messagebar-item-left">
														...
														<div class="inline position-relative">
															<a href="#" data-toggle="dropdown"
																...
																class="icon-caret-down bigger-125 middle"></i>
															</a>

															<ul class="dropdown-menu dropdown-lighter dropdown-100">
																<li><a id="id-select-message-all" href="#">全选</a>
																</li>

																<li><a id="id-select-message-none" href="#">不选</a>
																</li>

																<li class="divider"></li>

																<li><a id="id-select-message-unread" href="#">未读</a>
																</li>

																<li><a id="id-select-message-read" href="#">已读</a>
																</li>
															</ul>
														</div>
													</div>
											...
											<div id="id-message-new-navbar"
												...
												<div class="message-item-bar">
													<div class="messagebar-item-left">
														<a href="#"
															class="btn-back-message-list no-hover-underline"> <i
															class="icon-arrow-left blue bigger-110 middle"></i> <b
												...
												<div class="message-list" id="message-list">
													...
													<div class="message-item message-unread">
														<label class="inline"> <input type="checkbox"
															...
															class="attachment"> <i class="icon-paper-clip"></i>
													...
													<div class="message-item">
														<label class="inline"> <input type="checkbox"
															...
															class="sender" title="Philip Markov">Philip Markov
														</span> <span class="time">10:15 am</span> <span
															class="attachment"> <i class="icon-paper-clip"></i>
													...
													<div class="message-item">
														<label class="inline"> <input type="checkbox"
															...
															class="sender" title="Philip Markov">Philip Markov
														</span> <span class="time">Yesterday</span> <span
															class="attachment"> <i class="icon-paper-clip"></i>
														</span> <span class="summary"> <span
													...
													<div class="message-item">
														<label class="inline"> <input type="checkbox"
															...
															class="sender" title="Doctor Gomenz">Doctor Gomenz
														</span> <span class="time">April 5</span> <span class="summary">
															<span class="text"> Vim te vivendo convenire,
																summo fuisset </span>
														</span>
													</div>
													...
													<div class="message-item">
														<label class="inline"> <input type="checkbox"
															...
															class="time">April 4</span> <span class="summary">
													...
													<div class="message-item">
														<label class="inline"> <input type="checkbox"
															...
															class="time">April 3</span> <span class="summary">
											...
											<div class="message-footer clearfix">
												...
												<div class="pull-right">
													...
													<ul class="pagination middle">
														...
														<li><a href="#"> <i
																class="icon-step-forward middle"></i>
														</a></li>
													</ul>
												</div>
											</div>
					...
					<div class="hide message-content" id="id-message-content">
						<div class="message-header clearfix">
							<div class="pull-left">
								<span class="blue bigger-125"> Clik to open this message
								</span>

								<div class="space-4"></div>

								<i class="icon-star orange2 mark-star"></i> &nbsp; <img
									class="middle" alt="John's Avatar" src="avatars/avatar.png"
									width="32"> &nbsp; <a href="#" class="sender">John
									Doe</a> &nbsp; <i class="icon-time bigger-110 orange middle"></i> <span
									class="time">Today, 7:15 pm</span>
							</div>

							<div class="action-buttons pull-right">
								<a href="#"> <i
									class="icon-reply green icon-only bigger-130"></i>
								</a> <a href="#"> <i

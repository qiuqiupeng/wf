			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					...
					<li class="active open"><a href="#" class="dropdown-toggle">
							<i class="icon-tag"></i> <span class="menu-text"> More
								Pages </span> <b class="arrow icon-angle-down"></b>
					</a>
						...
						<div class="col-xs-12">
									...
									<div class="tabbable">
										<ul id="inbox-tabs"
											...
											<li class="li-new-mail pull-right"><a data-toggle="tab"
												href="#write" data-target="write" class="btn-new-mail">
													<span class="btn bt1n-small btn-purple no-border"> <i
											...
											<li><a data-toggle="tab" href="#draft"
												data-target="draft"> <i
													class="green icon-pencil bigger-130"></i> <span
															...
															<div class="message-toolbar hide">
																<div class="inline position-relative align-left">
																	...
																	<ul
																		...
																		<li><a href="#"> <i
																				class="icon-eye-open blue"></i> &nbsp; Mark as read
																		</a></li>
													...
													<div class="message-list-container">
														<div class="message-list" id="message-list">
															...
															<div class="message-item message-unread">
																<label class="inline"> <input type="checkbox"
																	class="ace"> <span class="lbl"></span>
																</label> <i class="message-star icon-star-empty light-grey"></i>
															...
															<div class="message-item">
																...
																<span class="sender" title="Shrek">Shrek </span> <span
																	...
																	class="message-flags"> <i
																		class="icon-flag icon-flip-horizontal light-grey"></i>
																</span> <span class="text"> Photo booth beard raw denim
										...
										<div class="col-sm-6 col-xs-12">
											<div class="input-icon block col-xs-12 no-padding">
												<input maxlength="100" type="text" class="col-xs-12"
													...
													placeholder="Subject"> <i class="icon-comment-alt"></i>
											</div>
										</div>
									</div>
							...
							<div class="hide message-content" id="id-message-content">
								<div class="message-header clearfix">
									<div class="pull-left">
										<span class="blue bigger-125"> Clik to open this
											message </span>
										...
										<i class="icon-star orange2 mark-star"></i> &nbsp; <img
											...
											src="avatars/avatar.png" width="32"> &nbsp; <a
											href="#" class="sender">John Doe</a> &nbsp; <i
											class="icon-time bigger-110 orange middle"></i> <span
									...
									<div class="action-buttons pull-right">
										<a href="#"> <i
											...
											class="icon-trash red icon-only bigger-130"></i>
										</a>
									</div>
								</div>
									...
									<div class="attachment-images pull-right">
										...
										<div>
											<img width="36" alt="image 4"
												src="images/gallery/thumb-4.jpg"> <img
												width="36" alt="image 3"
												src="images/gallery/thumb-3.jpg"> <img
												width="36" alt="image 2"
												src="images/gallery/thumb-2.jpg"> <img
												width="36" alt="image 1"

<!DOCTYPE html>
  ...
  <body>
    ...
    <header> <!-- Header start -->
      <a href="index" class="logo">StartUP</a> <!-- Logo -->
    ...
    <div class="container-fluid"> <!-- Bootstrap Container fluid start -->
      ...
      <div class="left-sidebar hidden-tablet hidden-phone"> <!-- Left sidebar start -->
        ...
        <div class="content"> <!-- Left sidebar content start -->

          <div id="accordion1" class="accordion no-margin"> <!-- Accordian start -->
